 ...
 * @author antho
 */
public class EmpleadoConHorasDobles extends Empleado implements CalcularSalario {

    private int horasExtras;
    double sal;

    public EmpleadoConHorasDobles(int horasExtras, int horastrabajadas, double suelporhora) {
